...
import { PromptExports, ScanResult, ScanStatus } from "./lib/types"
...
function IndexPopup() {
  ...
  const promptPreview = result.prompts.general
    ? `${result.prompts.general.slice(0, 220)}${
        result.prompts.general.length > 220 ? "…" : ""
      }`
